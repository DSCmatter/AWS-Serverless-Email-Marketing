...
def lambda_handler(event, context):
    ...
    bucket_name = 'some-bucket' # Replace with your bucket name
    ...
    try:
        ...
        for contact in contacts:
            ...
            response = ses_client.send_email(
                Source='some email',  # Replace with your verified "From" address
                Destination={'ToAddresses': [contact['Email']]},
                Message={
                    'Subject': {'Data': 'Your Weekly Study Remainder!', 'Charset': 'UTF-8'},
